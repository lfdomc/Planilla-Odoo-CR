{
    ...
    'data': [
        ...
        'views/dashboard_new_kpis.xml',
        'report/aguinaldo_report.xml',
        'report/aguinaldo_report_action.xml',
        ...
        'wizard/vacation_recalc_wizard_views.xml',
        'wizard/vacation_audit_wizard_views.xml',
        'wizard/payroll_accounting_review_views.xml',
